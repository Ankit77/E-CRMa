...
public class PurposeAdapter extends ArrayAdapter<PurposeModel> {
    ...
    private ArrayList<PurposeModel> values;

    public PurposeAdapter(Context context, int textViewResourceId,
                          ArrayList<PurposeModel> values) {
    ...
    public PurposeModel getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getPurpose());
