 ...
 */
public class NextActionAdapter extends ArrayAdapter<NextActionModel> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private ArrayList<NextActionModel> values;

    public NextActionAdapter(Context context, int textViewResourceId,
                             ArrayList<NextActionModel> values) {
    ...
    public NextActionModel getItem(int position) {
