...
public class DBProvider extends ContentProvider {
    ...
    static {
        ...
        MATCHER.addURI("com.symphony_ecrm.database.DBProvider",
        ...
        MATCHER.addURI("com.symphony_ecrm.database.DBProvider",
                DB.ADD_CUSTOMER_META_DATA, DB.ADD_CUSTOMER_CODE);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case DB.ADD_CUSTOMER_CODE: {
                long rowID = mDB.insert(DB.CUSTOMER, null, values);
                if (rowID > 0) {
                    Uri insertUri = ContentUris.withAppendedId(uri, rowID);
                    Log.e("DBProvider ->>>>>> ", rowID + " " + insertUri.toString());
                    Uri tempInsertUri = insertUri;
            ...
            case DB.ADD_CRM: {
                long rowID = mDB.insert(DB.CRM_CHECKINFO, null, values);
                if (rowID > 0) {
                    Uri insertUri = ContentUris.withAppendedId(uri, rowID);
                    Log.e("DBProvider ->>>>>> ", rowID + " " + insertUri.toString());
                    Uri tempInsertUri = insertUri;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case DB.ADD_CUSTOMER_CODE:
                queryBuilder.setTables(DB.CUSTOMER);
                sortOrder = DB.CUSTOMER_ID + " DESC ";
