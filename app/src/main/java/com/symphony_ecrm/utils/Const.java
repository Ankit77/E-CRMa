...
public class Const {
    ...
    public static final String USER_CACS = "CACS";
    public static final String USER_DOM = "DOM";

    public static final String ISLOADDATA = "LOADDATA";
    ...
    public static final String PREF_CUSTID = "PREF_CUSTID";
