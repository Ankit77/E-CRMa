...
//    }
    ...
    private void loadData(final boolean isEnable) {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                crmModel = e_sampark.getSymphonyDB().getVisit(CRMID);
                if (crmModel != null) {
