                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            int deletedRows = getActivity().getBaseContext().getContentResolver().
                                    delete(Uri.parse("content://com.symphony_ecrm.database.DBProvider/getDistributerMetaData"),
                                            null,
                                            null
                                    );
...
//		                    Log.e("BG  CO-ORDINATES", SMSService.addressLatLng+"");
    ...
    public boolean checkDistStatus(String distKey) {
        ...
        SharedPreferences prefs = this.getActivity().getSharedPreferences(getString(R.string.app_name), this.getActivity().MODE_PRIVATE);
    ...
    public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
        ...
        menu.findItem(R.id.distributer_add).setVisible(false);
